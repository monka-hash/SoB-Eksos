...
const LOCATIONS = {
  ...
  vennesla: { lat: 58.2743, lon: 7.9674, name: "Vennesla" },
  songdalen: { lat: 58.1831, lon: 7.8314, name: "Songdalen" },
  søgne: { lat: 58.0949, lon: 7.8024, name: "Søgne" },
  mandal: { lat: 58.0299, lon: 7.4605, name: "Mandal" },
  marnardal: { lat: 58.1729, lon: 7.4944, name: "Marnardal" },
  audnedal: { lat: 58.2133, lon: 7.3420, name: "Audnedal" },
  lindesnes: { lat: 58.0766, lon: 7.2511, name: "Lindesnes" },
  lyngdal: { lat: 58.1341, lon: 7.0747, name: "Lyngdal" },
  farsund: { lat: 58.0952, lon: 6.8042, name: "Farsund" },
  hægebostad: { lat: 58.3765, lon: 7.1478, name: "Hægebostad" },
  kvinesdal: { lat: 58.3191, lon: 6.9773, name: "Kvinesdal" },
  flekkefjord: { lat: 58.2978, lon: 6.6631, name: "Flekkefjord" },
  sirdal: { lat: 58.7371, lon: 6.7714, name: "Sirdal" },
  åseral: { lat: 58.6190, lon: 7.4579, name: "Åseral" },
  // Aust-Agder
  birkenes: { lat: 58.3363, lon: 8.2323, name: "Birkenes" },
  iveland: { lat: 58.4201, lon: 7.8745, name: "Iveland" },
  lillesand: { lat: 58.2506, lon: 8.3804, name: "Lillesand" },
  grimstad: { lat: 58.3396, lon: 8.5933, name: "Grimstad" },
  froland: { lat: 58.5637, lon: 8.6581, name: "Froland" },
  arendal: { lat: 58.4617, lon: 8.7721, name: "Arendal" },
  tvedestrand: { lat: 58.6175, lon: 8.9331, name: "Tvedestrand" },
  risør: { lat: 58.7192, lon: 9.2341, name: "Risør" },
  gjerstad: { lat: 58.8472, lon: 8.9316, name: "Gjerstad" },
  vegårshei: { lat: 58.7657, lon: 8.7680, name: "Vegårshei" },
  evje: { lat: 58.5895, lon: 7.7968, name: "Evje" },
  åmli: { lat: 58.7714, lon: 8.5183, name: "Åmli" },
  bygland: { lat: 59.0597, lon: 7.7942, name: "Bygland" },
  valle: { lat: 59.2026, lon: 7.5417, name: "Valle" },
  bykle: { lat: 59.3533, lon: 7.3783, name: "Bykle" },
...
client.on("interactionCreate", async (interaction) => {
  ...
  if (MEMBER_ROLE_ID) {
    try {
      ...
      console.error("Failed to assign member role:", e);
    }
  }

  // Set [SoB] nickname prefix if not already present
  const current = member.nickname || member.user.username;
  if (!current.startsWith("[SoB]")) {
    try {
      await member.setNickname(`[SoB] ${current}`);
    } catch (e) {
